...
//    private List<CreditCardResponse> creditCards;
    ...
    public UserPrincipal(Long id, String name, String surname, String phoneNumber, String email, List<CreditCard> creditCard, List<Order> orders, String password, String stripeCustomerId, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
        this.name = name;
        ...
        this.orderResponses = orders.stream().map(OrderResponse::new).collect(Collectors.toList());
